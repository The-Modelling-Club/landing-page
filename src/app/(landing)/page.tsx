  ...
  return (
    <div className="w-full overflow-x-hidden">
      <div className="grid lg:grid-cols-2 lg:p-6 w-full min-h-screen  ">
        <div className=" w-full h-full">
          <section className="p-4 grid gap-4 place-content-center  w-full h-full">
            ...
            >
              <span className=" line-clamp-1">📣 Providing local solutions through Computer Aided Engineering</span>
            ...
            <div className=" flex gap-4">
              <Button onClick={() => router.push("https://forms.gle/gkK1mkfs66EjzyDV8")} className="">
      ...
      <div className=" p-6 text-center bg-primary text-white ">
        <h3 className=" font-semibold mb-4">Support The Modeling Club's mission</h3>
        <p className=" max-w-screen-sm mx-auto">
          Help us provide better learning resources, software licenses, and project materials for students interested in Computer-Aided Engineering and
          simulation.
        </p>
        <Button
          onClick={() => {
