...
export const metadata: Metadata = {
  ...
  keywords:
    "engineering articles, green hydrogen, CFD, oil and gas, water treatment, bioenergy, chemical engineering, process engineering",
  openGraph: {
    title: "Articles | The Modeling Club - KNUST",
    description:
      "Latest engineering insights and breakthroughs from The Modeling Club",
